...
public class CommonUtil {
	...
	public static String getDoubleQuot(String str){
		str = str.replaceAll("\"", "&quot;"); // \": "를 문자로 인식
		return str;
	}
	
	// (개인 프로젝트) 게시판 첨부파일 경로
	public static String getBoardDir(HttpServletRequest request){
		String dir = request.getSession().getServletContext().getRealPath("/")+"attach/board";
		return dir;
	}
	...
	public static String getPdsDir(){
		String dir = "D:/track27_gkk/java_jsp_project/servlet_bike/src/main/webapp/attach/pds";
		return dir;
	}
